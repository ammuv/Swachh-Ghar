...
<div class="topnav" id="myTopnav">
  ...
  <a href="index.html">Logout</a>
   ...
   <div class="login">
      ...
      <form name="servant"  method="post">
        <h1><font color="white" size="10" face="Garamond"> Search Maids</font></h1><br>
        <input id="c" type="checkbox" name="work_list[]" value="city" onchange="cityselect(this);"><label><font size="6" color="white">By City</font></label>
        <input id="w" type="checkbox" name="work_list[]" value="Cleaning" onchange="workselect(this);"><label><font size="6" color="white">By Work</font></label> 

        <div id="city">
          <h3>Enter City Name:</h3>
          <input name="city" type="text" placeholder="City Name"/><br>
        </div>
          
        <div id="work">
            <h3> Select your option</h3><br>
            <input id="s" type="checkbox" name="work_lis[]" value="Sweeping""><label><font size="6" color="white">Sweeping</font></label>
            <input id="co" type="checkbox" name="work_lis[]" value="Cooking""><label><font size="6" color="white">Cooking</font></label><br/>
            <input id="cl" type="checkbox" name="work_lis[]" value="Cleaning""><label><font size="6" color="white">Cleaning</font></label> 
        </div>
            <br><br>
...
if($city != 'no')
    $sql  = "select * from Request a join HouseMaid b on a.MID = b.MID where b.City = '$city' and ";
else
    $sql  = "select * from Request a join HouseMaid b on a.MID = b.MID where b.City is not null and ";
