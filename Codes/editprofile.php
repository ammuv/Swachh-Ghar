...
<div class="topnav" id="myTopnav">
  ...
  <a href="logout.php">Logout</a>
			...
			<?php
					...
					$tsql= "SELECT * FROM HouseOwner where OID = $id";
					...
					while ($row = sqlsrv_fetch_array($getResults, SQLSRV_FETCH_ASSOC)) { ?>	
						<div class="login">
						  <div class="login-form">
						  	<form action = "updateownerdetails.php" method="post">
				  				<h3><center><font size="13" color="white" face="Garamond">Your Information </font></center></h3><br>
				  				<input type="button" onClick="parent.location='changeownerpassword.php'" value="Change Password" class="signup-button" style="width: 200px;" />
								<h3>Name:</h3>
