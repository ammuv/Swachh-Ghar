    ...
    <div class="login">
      <div class="login-form">
  		<form name="servant" action="postrequirementsowner.php" method="post">
		    ...
		    <input id="s" type="checkbox" name="work_list[]" value="Sweeping" onchange="sweepchange(this);"><label><font size="5" color="white" face="Garamond">Sweeping</font></label>
    		<input id="co" type="checkbox" name="work_list[]" value="Cooking" onchange="cookchange(this);"><label><font size="5" color="white" face="Garamond">Cooking</font></label><br/>
    		<input id="cl" type="checkbox" name="work_list[]" value="Cleaning" onchange="cleanchange(this);"><label><font size="5" color="white" face="Garamond">Cleaning</font></label> 
...
$sql = "select * from Request where OID=$id";
...
?>
  ...
  <br><h1><center><font color="white" face="Garamond" size="12">Requirements Posted</font></center></h1>
      ...
      <br><br>
    <form method="post" action="deleteownerrequirement.php">
