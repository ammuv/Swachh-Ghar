...
<div class="background">
   <div class="login">
      ...
      <form name="servant"  method="post" action="searchowners.php">
        ...
        <div id="city">
          ...
          <input name="city" type="text" placeholder="City Name" pattern="([A-Za-z]*|[' '])*" required/><br>
        </div>
          
        <div id="work">
            <h3><font color="white" size="6" face="Garamond"> Select your option:<br></font></h3>
...
$sql = "select a.OID, b.Name, a.SweepingSal, a.CookingSal, a.CleaningSal, b.City from request a join HouseOwner b on a.OID = b.OID where a.OID>0";
$getResults= sqlsrv_query($conn, $sql);

if(sqlsrv_has_rows($getResults)  != false){  
?>

  <br><h1><center><font color="white" face="Garamond" size="12">List of Owners posted for requirements</font></center></h1>

      <br><br>
    <form method="post" action="getownerinfo.php">
