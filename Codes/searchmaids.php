...
<div class="background">
      <br><br>
    <form method="post" action="searchmaidinfo.php">
      ...
      <tr>
        ...
        <div class="login" style="background : none;">
              <div class="login-form">
                <button onClick="parent.location='checkrequirementsowner.php'" type="button" class="btn btn-default">Back</button>
              </div>
            </div>
        </div>
...
<div class="background">
    <br><br><h1><center><font color="white" face="Garamond" size="15"><b> Maids not found! </b></font></center></h1><br>
    <button onClick="parent.location='checkrequirementsowner.php'" type="button" class="btn btn-default">Back</button><br><br><br>
</div>
