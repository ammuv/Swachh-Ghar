...
<?php
          ...
          while ($row = sqlsrv_fetch_array($getResults, SQLSRV_FETCH_ASSOC)) { ?> 
          	<div class="background"><br>
          		<h1><center><font color="white" face="Garamond" size="15"><b> Owner Profile </b></font></center></h1><br>
              <div class="container">
                  <div class="row">
...
<?php } 
      ...
      ?>
              ...
              <div class="login-form">
                <button onClick="parent.location='viewowners.php'" type="button" class="btn btn-default">Back</button>
              </div>
            </div>
</div>
</div>
